...
def run_network_scan(target_url):
    ...
    execute_scan(["sudo", "nmap", "--resolve-all", "--top-ports 1000", "-Pn", "-d", "-v", "--min-rate", "10000", "-sU", "-sV", "-T4", "--max-retries", "1", target_hostname, "-oX", udp_xml_file_path], udp_xml_file_path, udp_json_file_path, "UDP")
